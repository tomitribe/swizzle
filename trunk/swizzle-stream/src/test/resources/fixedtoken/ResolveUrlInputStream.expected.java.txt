...
private class ResolveURLInputStream extends DelimitedParsedStringReplacementInputStream {

    private ResolveURLInputStream(InputStream in, String startText, String end, URL url) {
        super(in, startText, end, new URLResolver(startText, end, url), false);
    }

    private static class URLResolver extends StringParsedStringHandler {
        public final URL parentURL;
        public final String startText;
        public final String end;

        private URLResolver(String startText, String end, URL parentURL) {
            this.startText = startText;
            this.end = end;
            this.parentURL = parentURL;
        }

        private String handleParsedString(String parsedString) throws IOException {
